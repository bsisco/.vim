...
" Version:      1.2
"
" This scheme should work in the GUI and in cterm's 256 color mode. It won't
" work in 8/16 color terminals.
"
" I based it on John Lam's initial VibrantInk port to Vim [1]. Thanks to a
" great tutorial [2], I was able to convert it to cterm 256 color mode. And
...
" [2] http://frexx.de/cterm-256-notes/
...
if has("gui_running")
  ...
  highlight Visual ctermbg=red ctermfg=white
endif
